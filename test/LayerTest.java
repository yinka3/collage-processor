...
public class LayerTest {
  ...
  public void testBadConstructor() {
    Layer layer1 = new Layer("first layer", 0, 5);
    Layer layer2 = new Layer("second layer", 5, 0);
    Layer layer3 = new Layer("third layer", -5, 5);
    Layer layer4 = new Layer("fourth layer", 5, -5);
  }
  ...
  public void testNewAlpha() {
    ...
    Layer layer1 = new Layer("firstLayer", this.height, this.width);
    RGBA[][] tempLayer = layer1.visualize();
